...
namespace SagaStateMachineWorkerService.Models
{
    public class OrderStateMachine : MassTransitStateMachine<OrderStateInstance>
    {
        ...
        public OrderStateMachine()
        {
            ...
            Event(()=>OrderCreatedRequestEvent, y=> y.CorrelateBy<int>(x=> x.OrderId, z=> z.Message.OrderId).SelectId(ContextBoundObject =>
            Guid.NewGuid()));
           ...
           ,            
            ...
            SetCompletedWhenFinalized(); //Deletes the records when finalized
        }
    }
}