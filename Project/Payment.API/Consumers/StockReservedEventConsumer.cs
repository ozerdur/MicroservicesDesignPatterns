    ...
    public class StockReservedEventConsumer:IConsumer<StockReservedEvent>
    {
        ...
        public async Task Consume(ConsumeContext<StockReservedEvent> context)
        {
            ...
            if(balance > context.Message.Payment.TotalPrice){
                ...
                await _publishEndpoint.Publish(new PaymentFailedEvent { BuyerId = context.Message.BuyerId, orderId = context.Message.OrderId, orderItems = context.Message.OrderItems, Message="Not enough balance"});
            }
        }
    }
}